...
(new Date(b.ts)).toLocaleTimeString();d.appendChild(a)}b.u&&(a=document.createElement("span"),a.classList.add("iChat"),a.classList.add("iChat-username"),a.innerHTML=b.u,d.appendChild(a));a=document.createElement("span");a.classList.add("iChat");a.classList.add("iChat-text");a.innerHTML=b.txt;d.appendChild(a);b.txt.includes(firebase.auth().currentUser.displayName.substring(0,4))&&d.classList.add("iChat-highlight");b=document.getElementById("iChat-messages");b.insertBefore(d,b.firstChild);return c}return""}s(b,
a){if(b=document.getElementById(b))a.ts&&(b.children[0].innerText=(new Date(a.ts)).toLocaleTimeString()),a.u&&(b.children[1].innerHTML=a.u),a.txt&&(b.children[2].innerHTML=a.txt)}async load(){if(!this.b){fetch("https://legend-of-iphoenix.github.io/iChat/version.json").then(a=>a.json()).then(a=>{this.version=a.version;this.g=a.releaseDate;this.h=a.releaseNotes;setTimeout(()=>{this.b=!0;console.log("iChat loaded.\n\u00a9 _iPhoenix_.\n\nVersion "+this.version+", released on "+this.g+". \nRelease notes: \n"+
